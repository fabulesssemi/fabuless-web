...
function ConvictionBadge({ level }: { level: ConvictionLevel }) {
  ...
  const labels: Record<ConvictionLevel, string> = {
    "VERY HIGH": "Strong Buy Signal",
    HIGH:        "Buy Signal",
    "MOD-HIGH":  "Mild Buy Signal",
    MODERATE:    "Neutral",
    AVOID:       "Avoid",
    CAUTIOUS:    "Cautious",
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1 mb-4">
        {([
          ["Strong Buy Signal", "bg-emerald-100 text-emerald-800 border-emerald-200", "CEO/CFO bought $500k+ of their own stock"],
          ["Buy Signal",        "bg-emerald-50 text-emerald-700 border-emerald-200",  "Insider bought $250k+ of their own stock"],
          ["Mild Buy Signal",   "bg-teal-50 text-teal-700 border-teal-200",           "Insider bought $100k–$250k of their own stock"],
          ["Neutral",           "bg-gray-100 text-gray-500 border-gray-200",          "No notable buying or selling"],
